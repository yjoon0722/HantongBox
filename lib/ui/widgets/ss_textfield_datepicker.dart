...
class SSTextFieldDatePicker extends StatefulWidget {
  ...
  @override
  _SSTextFieldDatePicker createState() => _SSTextFieldDatePicker();
}

class _SSTextFieldDatePicker extends State<SSTextFieldDatePicker> {
